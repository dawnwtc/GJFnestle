...
function OnAction(control) {
    ...
    switch (eleId) {
        ...
        case "btnDeleteRow":
            {
                window.Application.ShowDialog(GetUrlPath() + "/ui/delete_row.html", "删除行", 400*window.devicePixelRatio, 300*window.devicePixelRatio, false);
            }
            break
        case "btnSchedule":
            {
                //window.Application.ShowDialog(GetUrlPath() + "/ui/schedule/option.html", "选择账户", 400*window.devicePixelRatio, 300*window.devicePixelRatio, false);
                window.Application.ShowDialog(GetUrlPath() + "/ui/schedule/option.html", "选择账户", 400*window.devicePixelRatio, 300*window.devicePixelRatio, false); 
            }
            break
        default:
